...
pub fn new(args SimulatorInputArgs) !Simulator {
	...
	actions_nt := parser.find(
		filter: 'component_define,node_template_define,node_template_component_add'
	)!
	...
	actions_ri := parser.find(
		filter: 'regional_internet_add,regional_internet_nodes_add'
	)!
